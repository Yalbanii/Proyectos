...
public class FreebiePointsDataTest {
    ...
    void allArgsConstructor_shouldCreateObjectWithAllFieldsSet() {
        ...
        assertEquals(ARTICULO, data.getArticulo(), "El articulo no coincide.");
        ...
        assertEquals(DESCRIPCION, data.getDescripcion(), "La descripcion no coincide.");
    }
    ...
    void noArgsConstructor_andSetters_shouldSetAndRetrieveValues() {
        ...
        // Then
        assertEquals(FREEBIE_ID, data.getFreebieId(), "Getter/Setter de ID fallo.");
        assertEquals(ARTICULO, data.getArticulo(), "Getter/Setter de Articulo fallo.");
        assertEquals(newCosto, data.getCosto(), "Getter/Setter de Costo fallo.");
        assertEquals(newStock, data.getStockActual(), "Getter/Setter de Stock Actual fallo.");
