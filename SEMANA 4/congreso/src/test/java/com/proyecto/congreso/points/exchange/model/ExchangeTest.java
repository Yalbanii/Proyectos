...
public class ExchangeTest {
  ...
  @Test
    void noArgsConstructor_andSetters_shouldSetAndRetrieveValues() {
        ...
        // Then
        assertEquals(FREEBIE_ID, exchange.getFreebieId(), "Getter/Setter de Freebie ID fallo.");
        assertEquals(PUNTOS_REDUCIDOS, exchange.getPuntosReducidos(), "Getter/Setter de Puntos fallo.");
        assertEquals(ARTICULO, exchange.getArticulo(), "Getter/Setter de Artículo fallo.");
    ...
    void crear_shouldInitializeAllFieldsAndSetCurrentTime() {
        ...
        // Verificar que el ID se mantenga nulo (generado por MongoDB al guardar)
