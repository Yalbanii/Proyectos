...
public class ParticipantControllerTest {
    ...
    void shouldUpdateParticipantSuccessfully() throws Exception {
        ...
        // El service fue llamado con el ID correcto y un objeto Participant
    ...
    void shouldActivateParticipantSuccessfully() throws Exception {
        ...
        activatedParticipant.setStatus(Participant.ParticipantStatus.ACTIVE);
    ...
    void shouldDeactivateParticipantSuccessfully() throws Exception {
        ...
        deactivatedParticipant.setStatus(Participant.ParticipantStatus.INACTIVE);
