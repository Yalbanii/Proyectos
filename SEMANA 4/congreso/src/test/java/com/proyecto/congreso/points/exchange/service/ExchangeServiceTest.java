...
public class ExchangeServiceTest {
    ...
    void setUp() {
        ...
        // Exchange Mock (Resultado despues de guardar)
    ...
    void crearExchange_shouldThrowException_whenPassNotFound() {
        ...
        // Asegurar que no se altero el stock ni se guardo el registro
    ...
    void crearExchange_shouldThrowException_whenStockHandlerFails() {
        ...
        verify(eventPublisher, never()).publishEvent(any(ExchangeFailedEvent.class)); // No se revierte si falla la reduccion inicial.
    }
